Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/wangbaojun/testRepoVersionLib"
  # s.screenshots  = "www.example.com/screenshots_1.gif"
  s.license      = "MIT"				#开源协议
  s.author             = { "linyi31" => "linyi@jd.com" }

  s.source       = { :git => "https://github.com/wangbaojun/testRepoVersionLib.git", :tag => s.version ,:commit => "e494b72ba3d09fed59e285ff5b989be5d1a53e19"}
